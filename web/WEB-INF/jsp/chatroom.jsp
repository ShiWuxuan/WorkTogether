    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            $("#exitBtn").on("click",function(){
                closeWebsocket();
                location.href="${pageContext.request.contextPath}/team/myTeam/${userTel}";
            });
...
<div class="header">
    <div class="inHeader">
        <h1>聊天室</h1>
        <div class="style">
            <p>当前登录用户：${sessionScope.loginUser!=null?sessionScope.loginUser.nickname:"请登录" }&nbsp;&nbsp;&nbsp;<button id="exitBtn">退出聊天室</button></p>
        </div>
    </div>
</div>
<!--头部end-->
