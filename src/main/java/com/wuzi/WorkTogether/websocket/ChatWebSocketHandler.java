...
import com.wuzi.WorkTogether.domain.dto.MessageDto;
import com.wuzi.WorkTogether.domain.vo.ChatUser;
import com.wuzi.WorkTogether.utils.GsonUtils;
...
public class ChatWebSocketHandler implements WebSocketHandler {
    ...
    public void afterConnectionEstablished(WebSocketSession webSocketSession) throws Exception {
        ...
        msg.setText("【"+loginUser.getNickname()+"】 进入聊天室");
     ...
     * 那么一个大的或未知尺寸的消息将会被分割，
     * 并会收到多次消息
     * （会通过多次调用方法handleMessage(WebSocketSession, WebSocketMessage). ）
     * ·如果分为多条消息，那么可以
     * 通过一个api：org.springframework.web.socket.WebSocketMessage.isLast()
     * 是否是某条消息的最后一部分。
     * ·默认一般为false，消息不分割
     */
