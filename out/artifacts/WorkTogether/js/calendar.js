...
function todoMain() {
    ...
    function renderRow({todo: inputValue, category: inputValue2, id, date, time, done}) {
        ...
        checkElem.addEventListener("click", checkBoxClickCallback, false);
        checkElem.dataset.id = id;
        let tdElem1 = document.createElement("td");
        tdElem1.appendChild(checkElem);
    ...
    function onDrop(event) {
        ...
        //find the index of one to be inserted
        todoList.forEach((todoObj, index) => {
